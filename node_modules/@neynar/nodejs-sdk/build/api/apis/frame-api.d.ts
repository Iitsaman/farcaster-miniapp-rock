...
export declare const FrameApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    fetchFrameCatalog: (limit?: number, cursor?: string, timeWindow?: MiniAppTimeWindow, categories?: Array<FetchFrameCatalogCategoriesEnum>, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    fetchRelevantFrames: (viewerFid: number, timeWindow?: MiniAppTimeWindow, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    searchFrames: (q: string, limit?: number, cursor?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const FrameApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    fetchFrameCatalog(limit?: number, cursor?: string, timeWindow?: MiniAppTimeWindow, categories?: Array<FetchFrameCatalogCategoriesEnum>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FrameCatalogResponse>>;
    /**
     * Fetches the mini app meta tags from the URL
     * @summary Meta tags from URL
     * @param {string} url The mini app URL to crawl
     ...
     *
     */
    fetchRelevantFrames(viewerFid: number, timeWindow?: MiniAppTimeWindow, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchRelevantFrames200Response>>;
    /**
     * Fetch analytics for total-interactors, interactors, nteractions-per-cast and input-text.
     * @summary Analytics for the mini app
     * @param {string} frameUrl
     ...
     *
     */
    searchFrames(q: string, limit?: number, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FrameCatalogResponse>>;
    /**
     * Update an existing mini app with a list of pages, if it was made by the developer (identified by API key)
     * @summary Update mini app
     * @param {NeynarFrameUpdateReqBody} neynarFrameUpdateReqBody
