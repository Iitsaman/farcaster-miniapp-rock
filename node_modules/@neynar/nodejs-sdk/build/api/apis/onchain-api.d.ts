...
export declare const OnchainApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    fetchRelevantFungibleOwners: (contractAddress: string, network: FungibleOwnerRelevantNetwork, viewerFid?: number, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    fetchUserBalance: (fid: number, networks: Array<Network>, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    sendFungiblesToUsers: (xWalletId: string, transactionSendFungiblesRequest: TransactionSendFungiblesRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const OnchainApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    fetchRelevantFungibleOwners(contractAddress: string, network: FungibleOwnerRelevantNetwork, viewerFid?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RelevantFungibleOwnersResponse>>;
    /**
     * Fetches the token balances of a user given their FID
     * @summary Token balance
     * @param {number} fid FID of the user to fetch
     ...
     *
     */
    fetchUserBalance(fid: number, networks: Array<Network>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BalanceResponse>>;
    /**
     * Register a new farcaster account onchain. Optionally you can pass in signers along to register a new account and create multiple signers in a single transaction
     * @summary Register Farcaster account onchain
     * @param {RegisterUserOnChainReqBody} registerUserOnChainReqBody
     ...
     *
     */
    sendFungiblesToUsers(xWalletId: string, transactionSendFungiblesRequest: TransactionSendFungiblesRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransactionSendFungiblesResponse>>;
};
/**
